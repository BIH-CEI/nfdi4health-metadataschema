...
* DietAssessment.instrument ^comment = "<p><strong>Cardinality:</strong> 1..1</p>"
...
* DietAssessment.ffqItemsNumber ^comment = "<p><strong>Cardinality:</strong> 1..1, if DietAssessment.instrument == 'Food frequency questionnaire (FFQ)'; otherwise 0.. 0</p>"
...
* DietAssessment.mode ^comment = "<p><strong>Cardinality:</strong> 1..*</p>"
...
* DietAssessment.device ^comment = "<p><strong>Cardinality:</strong> 1..*</p>"
...
* DietAssessment.portionSizeEstimation ^comment = "<p><strong>Cardinality:</strong> 1..*</p>"
...
* DietAssessment.referencePeriodUnit ^comment = "<p><strong>Cardinality:</strong> 1..1</p>"
...
* DietAssessment.referencePeriodNumber ^comment = "<p><strong>Cardinality:</strong> 1..1</p>"
...
* DietAssessment.repeat ^comment = "<p><strong>Cardinality:</strong> 1..1</p>"
...
* DietAssessment.repeatFrequency ^comment = "<p><strong>Cardinality:</strong> 1..1, if DietAssessment.repeat == 'Yes'; otherwise 0.. 0</p>"
...
* DietAssessment.validity ^comment = "<p><strong>Cardinality:</strong> 1..1</p>"
...
* DietAssessment.validityReference ^comment = "<p><strong>Cardinality:</strong> 1..1, if DietAssessment.validity == 'Yes'; otherwise 0.. 0</p>"
...
* DietAssessment.reliability ^comment = "<p><strong>Cardinality:</strong> 1..1</p>"
...
* DietAssessment.reliabilityReference ^comment = "<p><strong>Cardinality:</strong> 1..1, if DietAssessment.reliability == 'Yes'; otherwise 0.. 0</p>"
...
* DietAssessment.dietarySupplements ^comment = "<p><strong>Cardinality:</strong> 1..1</p>"
