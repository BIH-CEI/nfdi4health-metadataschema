Logical: NFDI4Health_LM_MDS_Core_V3_3
Parent: Element
Id: nfdi4health-lm-mds-core-v3-3
Title: "NFDI4Health LM Core Metadataschema V3.3"
Description: "NFDI4Health Logical Model Core Metadataschema V3.3"
* ^url = "https://www.nfdi4health.de/fhir/metadataschema/StructureDefinition/LogicalModel/nfdi4health-lm-mds-core-v3-3"
...
Mapping: NFDI4Health_LM_MDS_Core_V3_3_Internal_Numbering
Id: NFDI4Health-LM-MDS-Core-V3-3-Internal-Numbering
Title: "NFDI4Health Core Metadataschema Version 3.3 Mapping to internal numbering of Metadataschema V3.3"
Source: NFDI4Health_LM_MDS_Core_V3_3
...
* Resource.descriptions -> "1.5"
* Resource.descriptions.text -> "1.5.1"
* Resource.descriptions.language -> "1.5.2"
* Resource.keywords -> "1.6"
* Resource.keywords.label -> "1.6.1"
* Resource.keywords.code -> "1.6.2"
* Resource.languages -> "1.7"
* Resource.webpage -> "1.8"
* Resource.nonStudyDetails -> "1.9"
* Resource.nonStudyDetails.version -> "1.9.1"
* Resource.nonStudyDetails.format -> "1.9.2"
* Resource.nonStudyDetails.useRights -> "1.9.3"
* Resource.nonStudyDetails.useRights.label -> "1.9.3.1"
* Resource.nonStudyDetails.useRights.link -> "1.9.3.2"
* Resource.nonStudyDetails.useRights.confirmations -> "1.9.3.3"
* Resource.nonStudyDetails.useRights.confirmations.authority -> "1.9.3.3.1"
* Resource.nonStudyDetails.useRights.confirmations.terms -> "1.9.3.3.2"
* Resource.nonStudyDetails.useRights.confirmations.irrevocability -> "1.9.3.3.3"
* Resource.nonStudyDetails.useRights.confirmations.supportByLicensing -> "1.9.3.3.4"
* Resource.nonStudyDetails.useRights.description -> "1.9.3.4"
* Resource.contributors -> "1.10"
* Resource.contributors.nameType -> "1.10.1"
* Resource.contributors.organisational -> "1.10.2"
* Resource.contributors.organisational.type -> "1.10.2.1"
* Resource.contributors.organisational.fundingIds -> "1.10.2.2"
* Resource.contributors.organisational.name -> "1.10.2.3"
* Resource.contributors.personal -> "1.10.3"
* Resource.contributors.personal.type -> "1.10.3.1"
* Resource.contributors.personal.givenName -> "1.10.3.2"
* Resource.contributors.personal.familyName -> "1.10.3.3"
* Resource.contributors.personal.identifiers -> "1.10.3.4"
* Resource.contributors.personal.identifiers.identifier -> "1.10.3.4.1" 
* Resource.contributors.personal.identifiers.scheme -> "1.10.3.4.2"
* Resource.contributors.email -> "1.10.4"
* Resource.contributors.phone -> "1.10.5"
* Resource.contributors.affiliations -> "1.10.6"
* Resource.contributors.affiliations.name -> "1.10.6.1"
* Resource.contributors.affiliations.address -> "1.10.6.2"
* Resource.contributors.affiliations.webpage -> "1.10.6.3"
* Resource.contributors.affiliations.identifiers -> "1.10.6.4"
* Resource.contributors.affiliations.identifiers.identifier -> "1.10.6.4.1" 
* Resource.contributors.affiliations.identifiers.scheme -> "1.10.6.4.2" 
* Resource.idsAlternative -> "1.11"
* Resource.idsAlternative.scheme -> "1.11.1"
* Resource.idsAlternative.identifier -> "1.11.2"
* Resource.ids -> "1.12"
* Resource.ids.identifier -> "1.12.1"
* Resource.ids.scheme -> "1.12.2"
* Resource.ids.relationType -> "1.12.3"
* Resource.ids.typeGeneral -> "1.12.4"
* Resource.idsNfdi4health -> "1.13"
* Resource.idsNfdi4health.identifier -> "1.13.1"
* Resource.idsNfdi4health.date -> "1.13.2"
* Resource.idsNfdi4health.relationType -> "1.13.3"
* Resource.nutritionalData -> "1.14"
* Resource.chronicDiseases -> "1.15"
