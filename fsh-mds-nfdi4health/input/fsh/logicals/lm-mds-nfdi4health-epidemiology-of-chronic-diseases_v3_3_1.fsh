...
* ChronicDiseasesEpidemiology 0..* BackboneElement "Chronic disease data collected in the Group of items providing information on chronic disease data collection."
...
* ChronicDiseasesEpidemiology.commonChronicDiseaseName 0..* CodeableConcept "Common chronic diseases on which data were collected" "Specification of the common chronic diseases on which data were collected in the Group of items providing information on chronic disease data collection."
...
* ChronicDiseasesEpidemiology.informationSources 0..* CodeableConcept "From which sources were data generated/extracted?" "Specification of the source(s) from which information was generated/extracted."
