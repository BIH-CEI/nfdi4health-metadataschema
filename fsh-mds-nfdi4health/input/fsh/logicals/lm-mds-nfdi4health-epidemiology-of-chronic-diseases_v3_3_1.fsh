...
* ChronicDiseasesEpidemiology ^comment = "Cardinality: 1..*, if Resource.chronicDiseases == 'Yes' AND Resource.classification.type == ('Study protocol' OR 'Informed consent form' OR 'Patient information sheet' OR 'Manual of operations (SOPs)' OR 'Statistical analysis plan' OR 'Data management plan' OR 'Case report form' OR 'Interview scheme\n                        and themes' OR 'Observation guide' OR 'Discussion guide' OR 'Participant tasks' OR 'Other study document' OR 'Other'); otherwise 0.. 0</p>\n* 1..* 1..*, if Resource.chronicDiseases == \"Yes\" AND Resource.classification.type == (\"Study protocol\" OR \"Informed consent form\" OR \"Patient information sheet\" OR \"Manual of operations (SOPs)\" OR \"Statistical analysis plan\" OR \"Data\n                                    management plan\" OR \"Case report form\" OR \"Interview scheme and themes\" OR \"Observation guide\" OR \"Discussion guide\" OR \"Participant tasks\" OR \"Other study document\" OR \"Other\")\n* 0..0 0..0, if Resource.chronicDiseases != \"Yes\" OR Resource.classification.type != (\"Study protocol\" OR \"Informed consent form\" OR \"Patient information sheet\" OR \"Manual of operations (SOPs)\" OR \"Statistical analysis plan\" OR \"Data\n                                    management plan\" OR \"Case report form\" OR \"Interview scheme and themes\" OR \"Observation guide\" OR \"Discussion guide\" OR \"Participant tasks\" OR \"Other study document\" OR \"Other\")"
