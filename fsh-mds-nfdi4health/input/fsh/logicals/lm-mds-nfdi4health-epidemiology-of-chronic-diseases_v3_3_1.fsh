...
* ChronicDiseasesEpidemiology.commonChronicDiseaseName 1..1 CodeableConcept "Common chronic diseases on which data were collected" "Specification of the common chronic diseases on which data were collected in the Group of items providing information on chronic disease data collection."
