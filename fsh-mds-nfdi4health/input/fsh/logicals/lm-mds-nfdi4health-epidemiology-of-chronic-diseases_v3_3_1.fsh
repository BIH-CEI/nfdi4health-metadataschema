...
* ChronicDiseasesEpidemiology.dataCollected 1..1 CodeableConcept "Type of data collected" "Specification of the type of data collected."
* ChronicDiseasesEpidemiology.dataCollected from NFDI4Health_VS_MDS_CD_DataCollected_NCI (required)

* ChronicDiseasesEpidemiology.informationSources 1..* CodeableConcept "From which sources were data generated/extracted?" "Specification of the source(s) from which information was generated/extracted."
