Logical: NFDI4Health_LM_MDS_Design_V3_3
Parent: Element
Id: nfdi4health-lm-mds-design-v3-3
...
Title: "NFDI4Health Metadataschema Module Design Version 3.3 Mapping to internal numbering of Metadataschema V3.3"
Source: NFDI4Health_LM_MDS_Design_V3_3

* Design -> "1.17"
* Design.primaryDesign -> "1.17.1"
* Design.studyType -> "1.17.2"
* Design.studyType.interventional -> "1.17.2.1"
* Design.studyType.nonInterventional -> "1.17.2.2"
* Design.conditions -> "1.17.3"
* Design.conditions.label -> "1.17.3.1"
* Design.conditions.classification -> "1.17.3.2"
* Design.conditions.code -> "1.17.3.3"
* Design.focus -> "1.17.4"
* Design.focus.label -> "1.17.4.1"
* Design.focus.classification -> "1.17.4.2"
* Design.focus.code -> "1.17.4.3"
* Design.groupsOfDiseases -> "1.17.5"
* Design.groupsOfDiseases.generally -> "1.17.5.1"
* Design.groupsOfDiseases.conditions -> "1.17.5.2"
* Design.mortalityData -> "1.17.6"
* Design.administrativeInformation -> "1.17.7"
* Design.administrativeInformation.ethicsCommitteeApproval -> "1.17.7.1"
* Design.administrativeInformation.status -> "1.17.7.2"
* Design.administrativeInformation.statusWhenIntervention -> "1.17.7.3"
* Design.administrativeInformation.stageStopped -> "1.17.7.4"
* Design.administrativeInformation.reasonStopped -> "1.17.7.5"
* Design.administrativeInformation.statusEnrollingByInvitation -> "1.17.7.6"
* Design.administrativeInformation.recruitmentStatusRegister -> "1.17.7.7"
* Design.administrativeInformation.startDate -> "1.17.7.8"
* Design.administrativeInformation.endDate -> "1.17.7.9"
* Design.centers -> "1.17.8"
* Design.centersNumber -> "1.17.9"
* Design.dataProviders -> "1.17.10"
* Design.dataProvidersNumber -> "1.17.11"
* Design.subject -> "1.17.12"
* Design.sampling -> "1.17.13"
* Design.sampling.method -> "1.17.13.1"
* Design.sampling.probabilityMethod -> "1.17.13.2"
* Design.sampling.nonProbabilityMethod -> "1.17.13.3"
* Design.dataSource -> "1.17.14"
* Design.dataSource.general -> "1.17.14.1"
* Design.dataSource.biosamples -> "1.17.14.2"
* Design.dataSource.imaging -> "1.17.14.3"
* Design.dataSource.omics -> "1.17.14.4"
* Design.dataSource.description -> "1.17.14.5"
* Design.primaryPurpose -> "1.17.15"
* Design.eligibilityCriteria -> "1.17.16"
* Design.eligibilityCriteria.ageMin -> "1.17.16.1"
* Design.eligibilityCriteria.ageMin.number -> "1.17.16.1.1"
* Design.eligibilityCriteria.ageMin.timeUnit -> "1.17.16.1.2"
* Design.eligibilityCriteria.ageMax -> "1.17.16.2"
* Design.eligibilityCriteria.ageMax.number -> "1.17.16.2.1"
* Design.eligibilityCriteria.ageMax.timeUnit -> "1.17.16.2.2"
* Design.eligibilityCriteria.genders -> "1.17.16.3"
* Design.eligibilityCriteria.inclusionCriteria -> "1.17.16.4"
* Design.eligibilityCriteria.exclusionCriteria -> "1.17.16.5"
* Design.population -> "1.17.17"
* Design.population.coverage -> "1.17.17.1"
* Design.population.countries -> "1.17.17.2"
* Design.population.region -> "1.17.17.3"
...
* Design.arms.description -> "1.17.19.3"
* Design.groups -> "1.17.20"
* Design.groups.label -> "1.17.20.1"
* Design.groups.description -> "1.17.20.2"
* Design.interventions -> "1.17.21"
* Design.interventions.name -> "1.17.21.1"
* Design.interventions.type -> "1.17.21.2"
* Design.interventions.description -> "1.17.21.3"
* Design.interventions.armsLabel -> "1.17.21.4"
* Design.exposures -> "1.17.22"
* Design.exposures.name -> "1.17.22.1"
* Design.exposures.type -> "1.17.22.2"
* Design.exposures.description -> "1.17.22.3"
* Design.exposures.groupsLabel -> "1.17.22.4"
* Design.outcomes -> "1.17.23"
* Design.outcomes.title -> "1.17.23.1"
* Design.outcomes.description -> "1.17.23.2"
* Design.outcomes.type -> "1.17.23.3"
* Design.outcomes.timeFrame -> "1.17.23.4"
...
* Design.dataSharingPlan.description -> "1.17.26.5"
* Design.dataSharingPlan.datashield -> "1.17.26.6"
* Design.dataSharingPlan.requestData -> "1.17.26.7"
* Design.dataSharingPlan.url -> "1.17.26.8"
* Design.dataSharingPlan.recordLinkage -> "1.17.26.9"
* Design.nonInterventional -> "1.17.27"
* Design.nonInterventional.timePerspectives -> "1.17.27.1"
* Design.nonInterventional.targetFollowUpDuration -> "1.17.27.2"
* Design.nonInterventional.targetFollowUpDuration.number -> "1.17.27.2.1"
* Design.nonInterventional.targetFollowUpDuration.timeUnit -> "1.17.27.2.2"
* Design.nonInterventional.targetFollowUpDuration.frequency -> "1.17.27.2.3"
* Design.nonInterventional.biospecimenRetention -> "1.17.27.3"
* Design.nonInterventional.biospecimenDescription -> "1.17.27.4"
* Design.interventional -> "1.17.28"
* Design.interventional.phase -> "1.17.28.1"
* Design.interventional.masking -> "1.17.28.2"
* Design.interventional.masking.general -> "1.17.28.2.1"
* Design.interventional.masking.roles -> "1.17.28.2.2"
* Design.interventional.masking.description -> "1.17.28.2.3"
* Design.interventional.allocation -> "1.17.28.3"
* Design.interventional.offLabelUse -> "1.17.28.4"