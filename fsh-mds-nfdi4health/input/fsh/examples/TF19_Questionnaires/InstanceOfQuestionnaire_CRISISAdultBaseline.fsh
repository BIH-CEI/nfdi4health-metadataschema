Instance: InstanceOfQuestionnaireCRISISAdultBaselineForm
InstanceOf: NFDI4Health_PR_MDS_Questionnaire
Title: "Example of the NFDI4Health PR MDS Questionnaire - CRISIS Questionnaire - Adult Self-Report Baseline Form: Current Form"
Usage: #example
//General information
* identifier[NFDI4Health].value = "95"
* title = "CRISIS Questionnaire - Adult Self-Report Baseline Form: Current Form"
...
- Life changes due to coronavirus/covid-19 crisis; Daily behaviors (e.g., sleep, physical activity, time outdoors);
...
* extension[label].extension[value].valueString = "CRISIS Adult Baseline Current Form"
