...
* extension[associatedParty].extension[party].valueReference = Reference(OrganizationExample1) 
* extension[associatedParty].extension[nameType].valueCoding = #C0220885 "Organizational (Qualitative Concept)"
