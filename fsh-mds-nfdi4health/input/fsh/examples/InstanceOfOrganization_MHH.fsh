...
* telecom[webpage].value = "https://www.mhh.de/"
* address.text = "Carl-Neuberg-Str. 1, 30625, Hannover, Germany"
* identifier[0].value = "00f2yqf98"
* identifier[=].type = $Remaining#081 "ROR"
* identifier[+].value = "grid.10423.34"
