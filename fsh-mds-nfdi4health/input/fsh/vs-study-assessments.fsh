...
* $SCT#39857003 "Weighing patient (procedure)"
* $SCT#14456009 "Measuring height of patient (procedure)"
* $SCT#445396007 "Measurement of circumference of waist (procedure)"
* $SCT#698094009 "Measurement of body mass index (procedure)"
* $SCT#1230136007 "Method for determining body fat percentage (observable entity)"
* $UMLS#C5544537 "Sociodemographic Factors (Idea or Concept)"
