...
* extension[roleOrganisational].value[x] from NFDI4Health_VS_MDS_Organisational_Roles_NCI_Local (required)
...
* extension[nameType].value[x] from NFDI4Health_VS_MDS_Role_Name_Type_UMLS (required)
...
* url = "https://www.nfdi4health.de/fhir/metadataschema/StructureDefinition/nfdi4health-ex-mds-associated-party" (exactly)
