...
* extension[ethicsCommiteeApproval] ^definition = "Status of the request for approval from the (leading) ethics committee."
...
* extension[status] ^short = "Overall status"
* extension[status] ^definition = "Overall status of the [RESOURCE]."
...
* extension[statusWhenIntervention] ^short = "Is the intervention ongoing or completed?"
* extension[statusWhenIntervention] ^definition = "Short input help: 	Select one value from the list."
...
* extension[statusEnrollingByInvitation] ^definition = "Specification whether participants are selected from a predetermined population."
