Alias: $nfdi4health-vs-mds-study-groups-of-diseases-generally-icd11-umls-local = https://www.nfdi4health.de/fhir/metadataschema/ValueSet/nfdi4health-vs-mds-study-diseases-generally-icd10-umls-local
...
* extension[generally].valueCoding from nfdi4health-vs-mds-study-groups-of-diseases-generally-icd10-umls-local (required)
