Profile: NFDI4Health_PR_MDS_Document_SK
Parent: DocumentReference
Id: nfdi4health-pr-mds-document-sl
Title: "NFDI4Health PR MDS Document SK"
Description: "Resource covering metadata of a document."
* ^url = "https://www.nfdi4health.de/fhir/metadataschema/StructureDefinition/nfdi4health-pr-mds-document-sk"
* ^version = "0.9"
* ^status = #draft
...
* masterIdentifier.system = "https://www.nfdi4health.de/" (exactly)
...
Mapping: NFDI4Health-Document-SK-to-FHIR
Id: NFDI4Health
Title: "NFDI4Health Document to FHIR Mapping"
Source: NFDI4Health_PR_MDS_Document_SK
