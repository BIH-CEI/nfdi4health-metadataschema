Profile: NFDI4Health_PR_MDS_Questionnaire_SK
Parent: Questionnaire
Id: nfdi4health-pr-mds-questionnaire-sk
Title: "NFDI4Health PR MDS Questionnaire"
Description: "Resource covering metadata of a questionnaire."
* ^url = "https://www.nfdi4health.de/fhir/metadataschema/StructureDefinition/nfdi4health-pr-mds-questionnaire-sk"
* ^version = "0.9"
* ^status = #draft
...
* extension contains
    ...
    NFDI4Health_EX_MDS_Related_NEW named relatedResources 0..1 and
...
Mapping: NFDI4Health-Questionnaire-SK-to-FHIR
Id: NFDI4Health
Title: "NFDI4Health to FHIR Mapping"
Source: NFDI4Health_PR_MDS_Questionnaire_SK
