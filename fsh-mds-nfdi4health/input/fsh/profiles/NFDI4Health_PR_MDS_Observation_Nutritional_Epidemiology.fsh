...
* -> "NE1 DietAssessment"
* component[instrument].valueCodeableConcept -> "NE1.1 DietAssessment.instrument"
* component[ffqItemsNumber].valueInteger -> "NE1.2 DietAssessment.ffqItemsNumber"
* component[mode].valueCodeableConcept -> "NE1.3 DietAssessment.mode"
* component[device].valueCodeableConcept -> "NE1.4 DietAssessment.device"
* component[portionSizeEstimation] -> "NE1.5 DietAssessment.portionSizeEstimation"
* component[referencePeriodUnit].valueCodeableConcept -> "NE1.6 DietAssessment.referencePeriodUnit"
* component[referencePeriodNumber].valueInteger -> "NE1.7 DietAssessment.referencePeriodNumber"
* component[repeat].valueBoolean -> "NE1.8 DietAssessment.repeat"
* component[repeatFrequency].valueInteger -> "NE1.9 DietAssessment.repeatFrequency"
* component[validity].valueBoolean -> "NE1.10 DietAssessment.validity"
* component[validityReference].valueString -> "NE1.11 DietAssessment.validityReference"
* component[reliability].valueBoolean -> "NE1.12 DietAssessment.reliability"
* component[reliabilityReference].valueString -> "NE1.13 DietAssessment.reliabilityReference"
* component[dietarySupplements].valueBoolean -> "NE1.14 DietAssessment.dietarySupplements"